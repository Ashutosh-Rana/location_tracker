...
class ButtonListMobile extends StatefulWidget {
  @override
  State<ButtonListMobile> createState() => _ButtonListMobileState();
}

class _ButtonListMobileState extends State<ButtonListMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        CustomSizedBox(height: screenHeight * .04),
        Align(
        ...
        PrimaryButton(
            onPressed: () {
              ...
              // ToastUtils.showToast(context, "Location Update Stopped");
            },
